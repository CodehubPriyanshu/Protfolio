              ...
              <CardHeader className="pb-4">
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <CardTitle className="text-xl sm:text-2xl mb-2 group-hover:neon-text transition-all duration-300">
                      {edu.course}
                    </CardTitle>
                  ...
                  <div className="text-center sm:text-right">
                    <div className="text-xl sm:text-2xl font-bold neon-text mb-1">{edu.grade}</div>
